...
//Specify full URL to down and right arrow images (23 is padding-right added to top level LIs with drop downs):
    arrowimages: { down: ['downarrowclass', 'http://thegioidulich.com/siteadmin/images/down.gif', 27], right: ['rightarrowclass', 'http://thegioidulich.com/siteadmin/images/right.gif'] },

transition: {overtime:300, outtime:300}, //duration of slide in/ out animation, in milliseconds
shadow: {enabled:false, offsetx:2, offsety:2},
