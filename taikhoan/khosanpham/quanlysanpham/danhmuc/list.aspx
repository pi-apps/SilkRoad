...
<body>
    <form id="form1" runat="server">
        <div>
            <fieldset>
                ...
                <div>
                    <table class="table table-bordered">
                        <tbody>
                            <tr>
                                <td class="td-width-title"><b>Chọn danh mục: </b></td>
                                <td>
                                    <asp:DropDownList CssClass="select2 form-control" Width="97%" ID="ddlMenuParent" runat="server"></asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td class="td-width-title"><b> </b></td>
                                <td>
                                    <asp:CheckBox ID="chkIsMa" runat="server" Text="Chọn làm mã sản phẩm" />
                                </td>
                            </tr>
                            <tr>
            ...
            <p style="background:rgb(255, 0, 0);color:#fff;padding:6px 12px;">Lưu ý, chỉ được chọn 1 danh mục làm mã</p>
            <fieldset>
                            ...
                            <asp:Repeater ID="rptDanhMuc" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td><%#Eval("Name") %></td>
                                        <td>
                                            <asp:ImageButton ID="imgDisplayCode" OnClick="imgDisplayCode_Click" runat="server" CommandArgument='<%# Eval("Id")%>' ImageUrl='<%# Eval("Code")%>' ToolTip="Đèn sáng được chọn làm mã" />
                                        </td>
                                        <td>
