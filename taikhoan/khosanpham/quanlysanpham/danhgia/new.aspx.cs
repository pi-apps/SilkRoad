...
public partial class Siteadmin_cauhinh_banner_new : AdminPageUtils
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                var model = dbConnect.pro_ProductComments.Single(n => n.Id == int.Parse(Request["Id"]));
                model.pro_ProductId = int.Parse(Request["parent"]);
                model.IpRate = ip;
                model.Image = "";
                ...
                dbConnect.SubmitChanges();
                ClientAlerter.ShowAndGoto("Cập nhật đánh giá sản phẩm thành công", "/prodraftadmin/khosanpham/quanlysanpham/danhgia/list.aspx?parent=" + Request["parent"]);
            }
        }
