...
<asp:Content ID="Content4" ContentPlaceHolderID="breadCrumbContentPlaceHolder" runat="Server">
    <script src="/user_upload/script/Common.js" type="text/javascript"></script>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/user_upload">Trang chủ</a></li>
            <li class="breadcrumb-item"><a href="#">Cửa hàng</a></li>
            <li class="breadcrumb-item"><a href="list.aspx">Danh sách cửa hàng đang cho thuê</a></li>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContentPlaceHolder" runat="Server">
    <div class="noidung">
        <div class="title">Chỉnh sửa cửa hàng</div>
        ...
        <div class="div-crud">
            <table class="table-crud">
                <tr>
                    ...
                    <td class="txt1">
                        <asp:DropDownList ID="ddlShopStatus" CssClass="form-control" runat="server"></asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td class="name1">
                ...
                <tr>
                    <td class="name1">
                        <label for="txtName">Tỷ giá</label>
                    </td>
                    <td class="txt1">
                ...
                <tr>
                    <td class="name1">
                        <label for="form-field-8">Banner</label>
                    </td>
                    <td class="txt1">
                        <asp:FileUpload ID="fulBanner" runat="server" ClientIDMode="Static" />
                        <p>
                            <asp:Image ID="imgBanner" Width="100px" ClientIDMode="Static" ImageUrl="~/user_upload/no-logo.png" runat="server" />
                        </p>
                    </td>
                </tr>
                <tr>
                    <td class="name1">
                        <label for="txtName">Liên kết banner</label>
                    </td>
                    <td class="txt1">
                        <asp:TextBox ID="txtLinkBanner" CssClass="form-control" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="name1">
