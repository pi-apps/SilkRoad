...
public partial class Siteadmin_cauhinh_banner_DanhSachBanner : AdminPageUtils
{
    ...
    {
        var models = dbConnect.company_Positions.OrderByDescending(n => n.CreatedAt);
    ...
    protected void btnDelete_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            company_Position model = dbConnect.company_Positions.Single(m => m.Id == int.Parse(l.CommandArgument));
            dbConnect.company_Positions.DeleteOnSubmit(model);
