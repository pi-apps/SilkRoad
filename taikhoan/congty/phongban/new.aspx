...
<asp:Content ID="Content4" ContentPlaceHolderID="breadCrumbContentPlaceHolder" runat="Server">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/prodraftadmin/congty/phongban/list.aspx">Danh sách phòng ban</a></li>
            <li class="breadcrumb-item active">Thêm mới/sửa phòng ban</li>
        </ol>
    </nav>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContentPlaceHolder" runat="Server">
    <div class="noidung">
        <div class="title">Thêm mới/sửa phòng ban</div>
            ...
            <table class="table-crud">
                ...
                <tr>
                    ...
                    <td class="txt1 bt1">
                        ...
                        <a href="/prodraftadmin/congty/phongban/list.aspx" class="btn btn-danger">Hủy</a>
                        </td>
                </tr>
                <tr>
