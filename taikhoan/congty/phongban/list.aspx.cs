...
public partial class Siteadmin_cauhinh_banner_DanhSachBanner : AdminPageUtils
{
    ...
    {
        var models = dbConnect.company_Departments.OrderByDescending(n => n.CreatedAt);
    ...
    protected void btnDelete_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            company_Department model = dbConnect.company_Departments.Single(m => m.Id == int.Parse(l.CommandArgument));
            dbConnect.company_Departments.DeleteOnSubmit(model);
