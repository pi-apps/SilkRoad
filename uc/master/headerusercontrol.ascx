<%@ Control Language="C#" AutoEventWireup="true" CodeFile="headerUserControl.ascx.cs" Inherits="UC_master_headerUserControl" %>
    ...
    <div class="container-fluid container-xl align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
            <ul id="menu-main-menu">
                ...
                <li class="menu-home-header-account menu-level-1" id="piLiSignIn">
                    <a href="javascript:;" class="login_pi">Sign In</a></li>
                <li class="menu-level-1 dropdown" id="piLiSignInfo">
                    <a href="javascript:void(0);"><span>
                        <img src="/upload/no-avatar.png" width="40" height="40" class="rounded-circle" /></span>
                        &nbsp;Tài khoản&nbsp;<i class="bi bi-chevron-down"></i></a>
                    <ul>
                ...
                <li class="menu-cart-header menu-level-1">
                    <a class="check-out-link" href="/checkout/cart.html">
            ...
            <ul class="menu-mobile-website">
                ...
                <li class="menu-mobile-website-level1"><a class="check-out-link" href="/checkout/cart.html">My Cart</a><a href="https://wallet.pi">Wallet.pi</a></li>

                <li class="menu-mobile-website-level1" id="piLiSignInMobile">
                    <a href="javascript:;" class="login_pi">Sign In</a>
                </li>
                <li class="menu-mobile-website-level1 dropdown"  id="piLiSignInfoMobile">
                    <a href="javascript:void(0);"><span>
                        <img src="/upload/no-avatar.png" width="40" height="40" class="rounded-circle" /></span>
                        &nbsp;Tài khoản&nbsp;<i class="bi bi-chevron-down"></i></a>
                    <ul>
...
<asp:HiddenField ID="hdfPiglobalUser" ClientIDMode="Static" runat="server" />