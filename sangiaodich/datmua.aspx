<%@ Page Title="" Language="C#" MasterPageFile="~/PiglobalMasterPage.master" AutoEventWireup="true" CodeFile="datmua.aspx.cs" Inherits="gianhang_chitietsanpham" %>
                        ...
                        <div class="trans-button">
                            ...
                            <asp:Panel ID="Panel2" Visible="false" runat="server">
                                <div class="alert alert-warning" role="alert">
                                    Người bán đã xác nhận chuyển hàng.
                                </div>
                            </asp:Panel>
