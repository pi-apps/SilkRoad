<%@ Page Title="" Language="C#" MasterPageFile="~/PiglobalMasterPage.master" AutoEventWireup="true" CodeFile="sanphamgianhang.aspx.cs" Inherits="gianhang_Default" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="seoContentPlaceHolder" runat="Server">
    ...
    <meta property="og:title" content="<%=category.SocialTitle %>" />
    <meta property="og:description" content="<%=category.SocialDescription %>" />
    <meta property="og:image:url" content="<%=urlDomainShare %>/<%=category.SocialImage %>" />
    <meta property="og:image" content="<%=urlDomainShare %>/<%=category.SocialImage %>" />
    <meta property="og:image:alt" content="<%=category.SeoTitle %>" />
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:title" content="<%=category.SocialTitle %>" />
    <meta name="twitter:description" content="<%=category.SocialDescription %>" />
    <meta name="twitter:image" content="<%=urlDomainShare %>/<%=category.SocialImage %>" />
</asp:Content>
