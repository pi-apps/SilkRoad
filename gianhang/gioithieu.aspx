<%@ Page Title="" Language="C#" MasterPageFile="~/PiglobalMasterPage.master" AutoEventWireup="true" CodeFile="gioithieu.aspx.cs" Inherits="gianhang_Default" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="bodyContentPlaceHolder" runat="Server">
    <main id="main" class="main-gian-hang">
        ...
        <div id="gioi-thieu" class="gioi-thieu-shop">
            <section id="about" class="about gioi-thieu-gian-hang-detail">
                        ...
                        <ItemTemplate>
                            <div class="row gx-0">
                                <div class="col-lg-12 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
                                    <div class="content">
                                        <h3><%#Eval("Name") %></h3>
                                        <div class="gioi-thieu-gian-hang-body">
                                            <%#Eval("Description") %>
                                        </div>
                                    </div>
                                </div>
