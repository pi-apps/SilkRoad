            ...
            <div class="row">
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <div class="div-content-trans">
                        ...
                        <h2>Sau khi nhận tiền, nhấp vào nút "Đã nhận, thông báo cho người mua".</h2>
                        <div class="trans-button">
                            <asp:Panel ID="Panel1" Visible="false" runat="server">
                                <a href="javascript:void(0);" id="xac-nhan-nhan-tien" class="btn btn-warning">Xác nhận, đã nhận tiền</a><p></p>
                            </asp:Panel>
